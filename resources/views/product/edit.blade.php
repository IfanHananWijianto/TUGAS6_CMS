            ...
            <div class="card">
                ...
                <form action="/product/index/{{ $produk->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control " id="exampleInputEmail1" name="nama" value="{{ $produk->nama }}" placeholder="nama produk">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Deskripsi</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="deskripsi" value="{{ $produk->deskripsi }}" placeholder="deskripsi produk">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Harga</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="harga" value="{{ $produk->harga }}" placeholder="harga">
                    </div>
                    ...
                    <div class="invalid-feedback"> Pilih salah satu kategori </div>
                        <br>
                    <div class="mt-3"><img src="{{ asset($produk->image) }}" id="output" width="100"></div>
                    <div class="mb-3 mt-4">
